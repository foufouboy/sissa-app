...
import { CreateUserInput, PrivateUser } from "../types/users";
...
export const UserModel = {
	...
	async findByIds(ids: number[]): Promise<PrivateUser[]> {
		try {
			const result = await query<PrivateUser>(
	...
	async create(data: CreateUserInput): Promise<PrivateUser> {
		try {

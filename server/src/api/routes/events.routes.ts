...
// TODO: prévoir des routes pour récupérer les évènements liés à un groupe, ou à un utilisateur (priorité moyenne)
// Pour l'instant le tri pourra se faire en front

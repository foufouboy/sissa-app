...
export const validationMiddleware = {
  ...
  event: [
    ...
    body("memberGroupsIds").isArray().withMessage("Liste de groupes invalide"),
  ],
  message: [
    body("subject")
      .isString()
    ...
    body("infoType")
      ...
      .isLength({ min: 3 })
      .withMessage("Type d'information trop court (minimum 3 caractères)"),
    body("messageType")
  ...
  settings: [
    body("notifications").isBoolean().withMessage("Notifications invalides"),
